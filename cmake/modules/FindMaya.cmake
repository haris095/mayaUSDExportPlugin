...
# MayaUSD include directory
find_path(MAYAUSD_INCLUDE_DIR mayaUsd/fileio/primWriter.h
    PATHS
        ${MAYA_USD_LOCATION}
    PATH_SUFFIXES
        "${MAYA_INC_SUFFIX}/"
    DOC "MayaUSD include path"
)
...
foreach(MAYAUSD_LIB ${_MAYAUSD_LIBRARIES})
    find_library(MAYAUSD_${MAYAUSD_LIB}_LIBRARY NAMES ${MAYAUSD_LIB} PATHS ${MAYAUSD_LIBRARY_DIR}
        NO_DEFAULT_PATH)
    if (MAYAUSD_${MAYAUSD_LIB}_LIBRARY)
        set(MAYA_USD_LIBRARIES ${MAYA_USD_LIBRARIES} ${MAYAUSD_${MAYAUSD_LIB}_LIBRARY})
    endif()
endforeach()
...
find_package_handle_standard_args(MayaUsd DEFAULT_MSG MU_INCLUDE MAYA_USD_LIBRARIES)
